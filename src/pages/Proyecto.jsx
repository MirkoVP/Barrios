  ...
  const equipo = [
    {
      ...
      link: 'https://www.instagram.com/ervasquezi/',
    },
    {
          ...
          {equipo.map((persona, idx) => (
            ...
            >
              <div className="mb-4">
                ...
                <p className="text-xs tracking-widest uppercase text-[var(--color-penco-gold-deep)] font-semibold">
                  {persona.rol}
                </p>
              </div>
              ...
              <div className="pt-3 border-t border-[var(--color-penco-blue-200)]/30">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--color-penco-blue-600)] text-white text-xs font-medium hover:bg-[var(--color-penco-gold-deep)] transition-all duration-300"
                >
                  Contacto
                  <span>↗</span>
                </a>
